...
function MovingCat() {
    ...
    useEffect(() => {
        const {backgroundColor, inverseColor} = themeColours[theme]
        setFill(
            {
                backgroundColor,
                inverseColor
    ...
    return (
        ...
        <div className="moving-cat-content">
            <div className="moving-cat-container">
                <svg id="bongo-cat" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 787.3 433.8">
                    ...
                    <g id="head">
                        ...
                        <g id="head__face">
                            <g id="eyes">
                                <use width="19.2" height="18.7" transform="translate(474.8 195.2)"
                                     xlinkHref="#eye"></use>
                                <use width="19.2" height="18.7"
                    ...
                    <g id="laptop">
                        <g id="laptop__base">
                            <polygon points="641.9 304.1 454.7 348.2 103.8 271.3 254.6 230.3 641.9 304.1"
                                     fill="whitesmoke"></polygon>
                            <path
                        ...
                        <g id="laptop__keyboard">
                            ...
                            <polygon
                                ...
                                fill={fill.backgroundColor}></polygon>
                            <polygon
                            ...
                            <polygon points="371.3 273.9 256.9 252.7 266.4 250.3 382.4 271.5 371.3 273.9"
                                     stroke="#2f2f2f"
                                     strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"></polygon>
                            <polygon points="237.6 264.9 221.4 261.7 230.4 259.4 246.8 262.6 237.6 264.9"
                                     stroke="#2f2f2f"
                                     strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"></polygon>
                            <polygon points="474.8 312 250 267.3 259.4 265.1 487.7 309.6 474.8 312" stroke="#2f2f2f"
                                     strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"></polygon>
                            <polygon points="412 308.5 204.4 266 213.1 263.8 423.9 306.3 412 308.5" stroke="#2f2f2f"
                                     strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"></polygon>
                            <polygon points="450.2 316.4 428.8 312 440.9 309.7 462.8 314.1 450.2 316.4" stroke="#2f2f2f"
                                     strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"></polygon>
                            <polygon points="201.7 273.1 187.7 270.2 196.2 268 210.4 271 201.7 273.1" stroke="#2f2f2f"
                                     strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"></polygon>
                            <polygon points="222.8 277.6 208.3 274.5 217.1 272.4 231.8 275.4 222.8 277.6"
                                     stroke="#2f2f2f"
                                     strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"></polygon>
                            <polygon points="363.1 307.3 231.7 279.5 240.9 277.3 374.2 305.1 363.1 307.3"
                                     stroke="#2f2f2f"
                                     strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"></polygon>
                            <polygon points="444.6 287.5 385.4 276.5 396.8 274.1 456.9 285 444.6 287.5" stroke="#2f2f2f"
                                     strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"></polygon>
                            <polygon points="526.3 302.7 460.3 290.4 473 288 540.1 300.2 526.3 302.7" stroke="#2f2f2f"
                                     strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"></polygon>
                            <polygon points="426.4 320.7 376.3 310.1 387.6 307.9 438.5 318.5 426.4 320.7"
                                     stroke="#2f2f2f"
                                     strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"></polygon>
                            <g>
                                <polygon points="410.7 285.6 399.1 288 500.1 307.4 513.5 305 410.7 285.6"
                                         stroke="#2f2f2f"
                                         strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"></polygon>
                                <polygon points="395.9 282.8 248.4 255 239.2 257.3 384.5 285.2 395.9 282.8"
                            ...
                            <g id="laptop__code">
                                <g stroke="#3DE0E8" strokeWidth="6" transform="matrix(-1 0 0 1 278 103)">
                                    <g id="f3" transform="translate(0 76)">
                                        <path className="typing-animation" id="f3-l9" d="M8,25L8,25"
                                              strokeDasharray="60,10"></path>
                                        <path className="typing-animation" id="f3-l8" d="M8,13L8,13"
                                              strokeDasharray="50,10"></path>
                                        <path className="typing-animation" id="f3-l7" d="M0,1L0,1"
                                              strokeDasharray="25,10"></path>
                                    </g>
                                    <g id="f2" transform="translate(0 38)">
                                        <path className="typing-animation" id="f2-l6" d="M8,25L8,25"
                                              strokeDasharray="40,10"></path>
                                        <path className="typing-animation" id="f2-l5" d="M8,13L8,13"
                                              strokeDasharray="60,10"></path>
                                        <path className="typing-animation" id="f2-l4" d="M0,1L0,1"
                                              strokeDasharray="30,10"></path>
                                    </g>
                                    <g id="f1">
                                        <path className="typing-animation" id="f1-l3" d="M8,25L8,25"
                                              strokeDasharray="60,10"></path>
                                        <path className="typing-animation" id="f1-l2" d="M8,13L8,13"
                                              strokeDasharray="60,10"></path>
                                        <path className="typing-animation" id="f1-l1" d="M0,1L0,1"
                                              strokeDasharray="60,10"></path>
                                    </g>
                                </g>
                            </g>
                        ...
                        <g id="laptop__cover" style={{mixBlendMode: "hard-light"}}>
                            <polygon points="440.7 347.2 90.3 275.6 4.7 3.8 353 36.7 440.7 347.2"
                                     fill="#f2f2f2"></polygon>
                            <path
